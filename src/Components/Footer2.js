  ...
  return (
    ...
    <div className='card'>
      ...
      <div className='details'>
        <h5 className="card-head">Built with Bootstrap 5</h5>
      ...
      <div className='details'>
        <h5 className="card-head">Detailed Documentation</h5>
      ...
      <div className='details'>
        <h5 className="card-head">Mobile Freindly Interface</h5>
      ...
      <div className='details'>
        <h5 className="card-head">Touch-Enabled Sliders</h5>
      ...
      <div className='details'>
        <h5 className="card-head">W3C Valid HTML Code</h5>
      ...
      <div className='details'>
        <h5 className="card-head">Kick-Start Your Development</h5>
      ...
      <div className='details'>
        <h5 className="card-head">Easy to Customize with Sass</h5>
      ...
      <div className='details'>
        <h5 className="card-head">Future Proof Java-Script</h5>
